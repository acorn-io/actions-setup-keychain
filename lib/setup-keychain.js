...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        let out;
        out = yield (0, utils_1.execThrow)('security', ['default-keychain'], 'getting default keychain');
        const def = (0, utils_1.cleanLine)(out.stdout);
        out = yield (0, utils_1.execThrow)('security', ['list-keychains'], 'listing keychains');
        ...
        yield (0, utils_1.execThrow)('security', ['list-keychains', '-s', NAME, ...list]), 'listing keychains';
        yield (0, utils_1.execThrow)('security', ['default-keychain', '-s', NAME], 'setting default keychain');
